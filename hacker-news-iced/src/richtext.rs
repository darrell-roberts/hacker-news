...
// pub struct SearchSpanOwnedIter<'a, 'b> {
//     last_index: usize,
//     search: Option<&'b str>,
//     text: String,
//     matcher: Option<Box<dyn Iterator<Item = (usize, &'a str)> + 'a>>,
...
// impl<'a, 'b> SearchSpanOwnedIter<'a, 'b> {
//     pub fn new(text: String, search: Option<&'b str>) -> Self {
//         Self {
//             last_index: 0,
//             search,
//             text,
...
// impl<'a, 'b: 'a> Iterator for SearchSpanOwnedIter<'a, 'b> {
//     type Item = Span<'a, AppMsg>;
...
//                 } else {
//                     self.finished = true;
//                     let slice = &self.text[self.last_index..];
//                     Some(span(slice.to_owned()))
//                 }
//             }
//             None => {
//                 self.finished = true;
//                 Some(span(self.text.clone()))
//             }
//         }
//     }
// }
