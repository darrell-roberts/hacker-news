...
pub fn text_link<'a, Message, Theme, Renderer>(
    text: impl ToString,
) -> Text<'a, Message, Theme, Renderer>
where
    Theme: StyleSheet,
...
pub struct Text<'a, Message, Theme, Renderer>
where
    Theme: StyleSheet,
...
impl<'a, Message, Theme, Renderer> Text<'a, Message, Theme, Renderer>
where
    Theme: StyleSheet,
    Renderer: text::Renderer,
{
...
impl<'a, Message, Theme, Renderer> Widget<Message, Theme, Renderer>
    for Text<'a, Message, Theme, Renderer>
where
    Theme: StyleSheet,
    Renderer: text::Renderer,
    Message: Clone,
...
impl<'a, Message, Theme, Renderer> From<Text<'a, Message, Theme, Renderer>>
...
where
    ...
    Message: Clone + 'a,
{
    fn from(text: Text<'a, Message, Theme, Renderer>) -> Element<'a, Message, Theme, Renderer> {
        Element::new(text)
    }
}

impl<'a, Message, Theme, Renderer> Clone for Text<'a, Message, Theme, Renderer>
where
    Theme: StyleSheet,
    Renderer: text::Renderer,
    Message: Clone,
...
impl<'a, Message, Theme, Renderer> From<&'a str> for Text<'a, Message, Theme, Renderer>
where
    Theme: StyleSheet,
    Renderer: text::Renderer,
{
...
/// accordingly.
pub fn update<'a, Message: Clone, P>(
    event: Event,
    layout: Layout<'_>,
    cursor: mouse::Cursor,
