...
impl Config {
    pub fn into_app(self, search_context: Arc<RwLock<SearchContext>>) -> App {
        ...
        App {
            ...
            header: HeaderState {
                search_context: search_context.clone(),
                article_count: config.index_config.article_count,
                article_type: config.index_config.article_type,
            ...
            footer: FooterState {
                ...
                last_update: None,
                scale: config.scale,
                current_index_stats: config.index_config.current_index_stats,
                index_stats,
                index_progress: None,
            },
            article_state: ArticleState {
                ...
                search: None,
                viewing_item: None,
                article_limit: config.index_config.article_count,
            ...
            focused_pane: None,
            content: Content::Empty(config.index_config.article_type),
            history: Vec::new(),
        }
    }
}
