...
<template>
  <dialog ref="dialog">
    <div class="top">
      ...
      <div @click="close" style="font-size: 2rem; margin-right: 10px" class="close">
        X
      </div>
    </div>
    ...
    <div class="content">
      ...
      <div v-if="state.item?.text?.length" class="text-talk-bubble text-tri-right right-top">
        <RichText :richText="state.item?.text" />
      </div>
